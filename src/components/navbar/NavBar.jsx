  ...
  const [routes,setRoutes] = useState([
    {
      url: '/dashboard',
      text: 'Dashboard',
      Icon: <GoHomeFill className='flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white' />
    },
    {
      url: '/dashboard/events',
      text: 'Events',
      Icon: <MdEventAvailable className='flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white' />
    },
    {
      url: '/dashboard/sponsorships',
      text: 'Sponsorships',
      Icon: <GoSponsorTiers className='flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white' />
    },
    {
      url: '/dashboard/partners',
      text: 'Partners',
      Icon: <GiThreeFriends className='flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white' />
    },
    {
      url: '/dashboard/speakers',
      text: 'Speakers',
      Icon: <FaMicrophoneLines className='flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white' />
    },
    {
      url: '/dashboard/users',
      text: 'Users',
      Icon: <FaUsers className='flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white' />
    }
  ])
  return (
